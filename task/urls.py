...
from task.views import (
    ...
    TaskTypeDeleteView,
    TaskTypeUpdateView,
    TaskTypeCreateView, TaskListView, TaskUpdateView, TaskDeleteView, TaskCreateView, TaskDetailView, WorkerListView,
    WorkerCreateView, WorkerUpdateView, WorkerDeleteView, WorkerDetailView, PositionListView, PositionCreateView,
    PositionUpdateView, PositionDeleteView, TeamListView, TeamCreateView, ProjectListView, ProjectCreateView,
    TeamDetailView, TeamUpdateView, TeamDeleteView, ProjectDetailView, ProjectUpdateView, ProjectDeleteView, contact_us,
    privacy
)
